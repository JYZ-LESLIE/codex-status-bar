...
/usr/bin/plutil -insert CFBundleShortVersionString -string 0.5.0 "$APP_DIR/Contents/Info.plist"
/usr/bin/plutil -insert CFBundleVersion -string 5 "$APP_DIR/Contents/Info.plist"
