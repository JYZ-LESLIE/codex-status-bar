...
/usr/bin/plutil -insert CFBundleShortVersionString -string 0.1.0 "$APP_DIR/Contents/Info.plist"
/usr/bin/plutil -insert CFBundleVersion -string 1 "$APP_DIR/Contents/Info.plist"
