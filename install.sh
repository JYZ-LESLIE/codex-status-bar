...
/usr/bin/plutil -insert CFBundleShortVersionString -string 0.4.0 "$APP_DIR/Contents/Info.plist"
/usr/bin/plutil -insert CFBundleVersion -string 4 "$APP_DIR/Contents/Info.plist"
