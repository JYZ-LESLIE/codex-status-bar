...
/usr/bin/plutil -insert CFBundleShortVersionString -string 0.6.3 "$APP_DIR/Contents/Info.plist"
/usr/bin/plutil -insert CFBundleVersion -string 9 "$APP_DIR/Contents/Info.plist"
