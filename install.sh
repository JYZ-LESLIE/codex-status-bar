...
/usr/bin/plutil -insert CFBundleShortVersionString -string 0.6.0 "$APP_DIR/Contents/Info.plist"
/usr/bin/plutil -insert CFBundleVersion -string 6 "$APP_DIR/Contents/Info.plist"
