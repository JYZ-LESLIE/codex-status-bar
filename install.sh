...
/usr/bin/plutil -insert CFBundleShortVersionString -string 0.6.1 "$APP_DIR/Contents/Info.plist"
/usr/bin/plutil -insert CFBundleVersion -string 7 "$APP_DIR/Contents/Info.plist"
