...
/usr/bin/plutil -insert CFBundleShortVersionString -string 0.6.4 "$APP_DIR/Contents/Info.plist"
/usr/bin/plutil -insert CFBundleVersion -string 10 "$APP_DIR/Contents/Info.plist"
